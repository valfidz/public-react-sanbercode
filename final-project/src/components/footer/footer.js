...
export const Footer = () => {
    ...
    return (
        <footer className="text-gray-500 bg-gray-900 px-4 py-5 w-full mx-auto md:px-8">
            ...
            <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
                {
                    footerNavs.map((item, idx) => (
                        <li key={"zzz" + idx} className=" hover:text-gray-800">
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2024 Stip Jobs All rights reserved.
                </div>
                <div className="mt-6 sm:mt-0">
                    <ul className="flex items-center space-x-4">
                        <li key={"xxx-1"} className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="">
                        ...
                        <li key={"xxx-2"} className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="">
                        ...
                        <li key={"xxx-3"} className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="">
                        ...
                        <li key={"xxx-4q"} className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="">
