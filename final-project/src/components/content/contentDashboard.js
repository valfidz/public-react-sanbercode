        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
                    ...
                    <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">How to find a job on Stip Jobs</h1>
                    <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Stip jobs provide you job varieties from the whole world. Apply and get a job now!</p>
